...
import {productSection } from "../core/selector"
...
export const createProductCard = ({image, title, description,price}) => {
  ...
  />
    ...
    >
      ...
      >
        <div class="flex rating-start">
          <svg
            ...
            stroke-width="1.5"
            stroke="currentColor"
            class="w-6 h-6 fill-neutral-700 stroke-neutral-700"
          >
            <path
          ...
          <svg
            ...
            stroke-width="1.5"
            stroke="currentColor"
            class="w-6 h-6 fill-neutral-300 stroke-neutral-300"
          >
            <path
              stroke-linecap="round"
              stroke-linejoin="round"
      ...
      <button class="border w-full block border-neutral-700 p-3">
        Add to Cart
      </button>
    </div>
  </div>
